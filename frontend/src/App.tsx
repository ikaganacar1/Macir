...
const GroceryWasteEntry = lazy(() => import('./pages/GroceryWasteEntry'));
const GroceryReturns = lazy(() => import('./pages/GroceryReturns'));
const GroceryPriceEditor = lazy(() => import('./pages/GroceryPriceEditor'));
